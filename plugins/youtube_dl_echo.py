...
async def echo(bot, update):
    ...
    if update_channel:
        try:
            ...
            #await update.reply_text(f"Join @{etRobot_list} To Use Me")
            await update.reply_text(
                text="**Join My Updates Channel to use ME 😎 🤭**",
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="Join My Bot Channel", url=f"https://t.me/etRobot_list")]
              ])
            )
            return
        except Exception:
            await update.reply_text(
              text="Something Wrong. Try again " 
               reply_markup=InlineKeyboardMarkup([
                   [ InlineKeyboardButton (text="Contact Me", url=f"https://t.me/et_anon")]
               ])
               )
            return
